...
class DocumentCard extends React.Component {
    render() {
        return(
            <Cell col={6}>
                <Card shadow={0} style={{width: '100%', height: '200px', margin: 'auto'}}>
                    ...
                    <CardActions border>
                        <a href={this.props.url} target="_blank" rel="noopener noreferrer"><Button colored>View Resource</Button></a>
                    </CardActions>
                </Card>
            </Cell>
        );
